...
public abstract class RendererLivingEntity extends Render
{
    ...
    protected void renderModel(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        if(!par1EntityLivingBase.isInvisible() || Hooks.invisibleBypass()) //titanka
        {
        	GL11.glPushMatrix();
            ...
            this.mainModel.render(par1EntityLivingBase, par2, par3, par4, par5, par6, par7); //non titanka
    ...
    protected void passSpecialRender(EntityLivingBase par1EntityLivingBase, double par2, double par4, double par6)
    {
        ...
        if (this.func_110813_b(par1EntityLivingBase))
        {
            ...
            if (d3 < (double)(f2 * f2))
            {
                ...
                Hooks.renderESP(this, par1EntityLivingBase, par2, par4, par6); //titanka
     ...
     */
    public void renderLivingLabel(EntityLivingBase par1EntityLivingBase, String par2Str, double par3, double par5, double par7, int par9)
    {
        double d3 = par1EntityLivingBase.getDistanceSqToEntity(this.renderManager.livingPlayer);
