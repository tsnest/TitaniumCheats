...
public class RenderLiving extends Render
{
    ...
    {
        if (!par1EntityLiving.getHasActivePotion() || Hooks.invisibleBypass()) //titanka
        {
        	GL11.glPushMatrix();
            ...
            this.loadDownloadableImageTexture(par1EntityLiving.skinUrl, par1EntityLiving.getTexture()); //non titanka
            this.mainModel.render(par1EntityLiving, par2, par3, par4, par5, par6, par7); //non titanka
    ...
    protected void passSpecialRender(EntityLiving par1EntityLiving, double par2, double par4, double par6)
    {
        ...
        if(par1EntityLiving instanceof EntityPlayer) {
        	Hooks.renderESP(this, (EntityPlayer)par1EntityLiving, par2, par4, par6);
        }
    }

    /**
     * Draws the debug or playername text above a living
     * titanka changed to public
     */
    public void renderLivingLabel(EntityLiving par1EntityLiving, String par2Str, double par3, double par5, double par7, int par9)
    {
