...
public class Hooks {
	...
	public static AxisAlignedBB jesus(BlockFluid bf, int x, int y, int z) {
		return !setts("je") ? null : AxisAlignedBB.getAABBPool().getAABB((double)x + bf.getBlockBoundsMinX(), (double)y + bf.getBlockBoundsMinY(), (double)z + bf.getBlockBoundsMinZ(), (double)x + bf.getBlockBoundsMaxY(), (double)y + bf.getBlockBoundsMaxY(), (double)z + bf.getBlockBoundsMaxZ());
	}
