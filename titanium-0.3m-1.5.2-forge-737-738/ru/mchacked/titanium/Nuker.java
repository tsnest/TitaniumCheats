	...
	public void Method157() {
		if(!this.Field125.isEmpty()) {
			if(mc.thePlayer != null) {
				...
				mc.thePlayer.sendQueue.addToSendQueue(new Packet14BlockDig(0, pos.x, pos.y, pos.z, 0));
				mc.thePlayer.sendQueue.addToSendQueue(new Packet14BlockDig(2, pos.x, pos.y, pos.z, 0));
