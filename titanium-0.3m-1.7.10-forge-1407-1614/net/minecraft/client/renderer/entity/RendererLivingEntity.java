...
public abstract class RendererLivingEntity extends Render
{
    ...
    protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        if (!p_77036_1_.isInvisible() || Hooks.invisibleBypass()) //titanka
        {
        	GL11.glPushMatrix();
            ...
            this.mainModel.render(p_77036_1_, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_); //non titanka
    ...
    protected void passSpecialRender(EntityLivingBase p_77033_1_, double p_77033_2_, double p_77033_4_, double p_77033_6_)
    {
        ...
        if (this.func_110813_b(p_77033_1_))
        {
            ...
            if (d3 < (double)(f2 * f2))
            {
                ...
                Hooks.renderESP(this, p_77033_1_, p_77033_2_, p_77033_4_, p_77033_6_); //titanka
