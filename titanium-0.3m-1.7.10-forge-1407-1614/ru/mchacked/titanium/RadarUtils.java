...
public class RadarUtils {
	...
	public void Method151(int x, int y, int u, int v, int w, int h) {
		...
		tessellator.addVertexWithUV((double)(x + 0), (double)(y + h), 0.0D, (double)((float)(u + 0) * f), (double)((float)(v + h) * f1));
		tessellator.addVertexWithUV((double)(x + w), (double)(y + h), 0.0D, (double)((float)(u + w) * f), (double)((float)(v + h) * f1));
		tessellator.addVertexWithUV((double)(x + w), (double)(y + 0), 0.0D, (double)((float)(u + w) * f), (double)((float)(v + 0) * f1));
		tessellator.addVertexWithUV((double)(x + 0), (double)(y + 0), 0.0D, (double)((float)(u + 0) * f), (double)((float)(v + 0) * f1));
		tessellator.draw();
	}
	...
	private void Method152() {
		...
		while(i$.hasNext()) {
			...
			if(!mc.thePlayer.getCommandSenderName().equals(p.getCommandSenderName())) {
