...
public class TGui extends GuiScreen implements IMainGui {
	...
	public void initGui() {
		...
		this.Field69 = new GuiTextField(0, super.fontRendererObj, 4, super.height - 12, super.width - 8, 12);
	...
	public void drawScreen(int mX, int mY, float par3) {
		...
		super.fontRendererObj.drawString(Titanium.Method46() + " §a [GUI]", 1, 1, 16777215, true);
		...
		while(copyright.hasNext()) {
			copy_w = (GuiRenderer)copyright.next();
			if(copy_w == mww) {
				copy_w.Method188(super.fontRendererObj, mX - copy_w.Field156, mY - copy_w.Field157);
			} else {
				copy_w.Method188(super.fontRendererObj, -999, -999);
			}
		}
		
		this.Field69.drawTextBox();
		String copyright1 = this.Method65();
		int copy_w1 = super.fontRendererObj.getStringWidth(copyright1);
		super.fontRendererObj.drawString(copyright1, super.width - copy_w1 - 2, 2, 16777215, true);
	}
	...
	@Override
	protected void mouseClicked(int xPos, int yPos, int btn) throws IOException {
		super.mouseClicked(xPos, yPos, btn);
		int close_w = super.fontRendererObj.getStringWidth("X");
	...
	@Override
	protected void mouseReleased(int xPos, int yPos, int btn) {
		super.mouseReleased(xPos, yPos, btn);
		if(this.Field65 != null) {
			if(btn < 0) {
