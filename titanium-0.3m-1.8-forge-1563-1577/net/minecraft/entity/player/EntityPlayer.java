...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void onUpdate()
    {
        ...
        if(!Hooks.freecam() && !Hooks.setts("fcn")) { //titanka noClip 1.8 fix
    ...
    {
    	//titanka
        return Hooks.freecam() ? false : !this.sleeping && super.isEntityInsideOpaqueBlock();
    }
     ...
     * TSNest: titanka speedhack new
     */
    public float getAIMoveSpeed()
    {
    	float speed = (float)this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).getAttributeValue();
        return Hooks.speedhack() ? Hooks.speedhack0(speed, false) : speed;
    }
    ...
    {
    	//titanka
        if (!this.capabilities.isFlying && !Hooks.ignoreWeb())
        {
            super.setInWeb();
        }
    }
