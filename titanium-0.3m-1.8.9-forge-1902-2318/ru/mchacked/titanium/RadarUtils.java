...
public class RadarUtils {
	...
	public void Method151(int x, int y, int u, int v, int w, int h) {
		...
		worldrenderer.pos((double)(x + 0), (double)(y + h), 0.0D).tex((double)((float)(u + 0) * f), (double)((float)(v + h) * f1)).endVertex();
		worldrenderer.pos((double)(x + w), (double)(y + h), 0.0D).tex((double)((float)(u + w) * f), (double)((float)(v + h) * f1)).endVertex();
		worldrenderer.pos((double)(x + w), (double)(y + 0), 0.0D).tex((double)((float)(u + w) * f), (double)((float)(v + 0) * f1)).endVertex();
